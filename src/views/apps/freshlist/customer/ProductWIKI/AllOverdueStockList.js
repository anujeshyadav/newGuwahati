...
class AllOverdueStockList extends React.Component {
                        ...
                        render={({ history }) => (
                          <span
                            ...
                            <Eye
                              ...
                              onClick={() =>
                                history.push(
                                  `/app/Ajgroup/Stock/OverDueStockReport/${params?.data?._id}`
                                )
                              }
                            />
                          </span>
          ...
          <Col sm="12">
            <Card>
              <Row className="mt-2 ml-2 mr-2">
                <Col>
                  <h1 className="float-left">OverDue Stock</h1>
                </Col>
...
export default AllOverdueStockList;
