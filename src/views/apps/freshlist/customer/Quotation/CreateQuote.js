    ...
    <div>
      <div>
        <Card>
          <Row className="m-2">
            <Col>
              <h1 className="float-left">Create Quote</h1>
            </Col>
          </Row>
              ...
              <Row className="mb-2">
                <Col lg="6" md="6">
                  <FormGroup>
                    <Label>
                      {
                        dropdownValue.CreateQuote?.MyDropdown1?.dropdown?.label
                          ?._text
                      }
                    </Label>
                    <CustomInput
                      ...
                      type="select"
                      name={
                        dropdownValue.CreateQuote?.MyDropdown1?.dropdown?.name
                          ?._text
                      }
                      value={
                        formData[
                    ...
                    >
                      ...
                      {dropdownValue?.CreateQuote?.MyDropdown1?.dropdown?.option.map(
                        (option, index) => (
                          <option
                            key={index}
                ...
                <Col lg="6" md="6">
                  <FormGroup>
                    <Label>
                      {
                        dropdownValue.CreateQuote?.MyDropdown?.dropdown?.label
                          ?._text
                      }
                    </Label>
                    <CustomInput
                      ...
                      type="select"
                      name={
                        dropdownValue.CreateQuote?.MyDropdown?.dropdown?.name
                          ?._text
                      }
                      value={
                        formData[
                    ...
                    >
                      ...
                      {dropdownValue?.CreateQuote?.MyDropdown?.dropdown?.option.map(
                        (option, index) => (
                          <option
                            key={index}
                            value={option?._attributes?.value}
                ...
                {CreatAccountView &&
                  CreatAccountView?.CreateQuote?.input?.map((ele, i) => {
                    let View = "";
                    let Edit = "";
                    if (ele?.role) {
                ...
                <div className="container">
                  ...
                  <div>
                    {CreatAccountView &&
                      CreatAccountView?.CreateQuote?.CheckBox?.input?.map(
                        (ele, i) => {
                          return (
                            <>
              ...
              <Row className="mt-2 ">
                <Col lg="6" md="6" sm="6" className="mb-2">
                  ...
                  <div className="form-label-group mx-1">
                    {CreatAccountView &&
                      CreatAccountView?.CreateQuote?.Radiobutton?.input?.map(
                        (ele, i) => {
                          return (
                            <FormGroup key={i}>
                              <Input
