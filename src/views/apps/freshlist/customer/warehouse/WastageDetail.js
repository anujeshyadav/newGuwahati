...
//               </div>
//             ) : params.data?.warehouse?.typeStatus === "Damaged" ? (
...
//                           // });
//                           this.setState({
//                             Wastage_status: params?.data?.warehouse?.typeStatus,
//                           });
//                           this.setState({
//                             Dam_Percentage:
...
//     const InsidePermissions = CheckPermission("Wastage Detail");
//     this.setState({ InsiderPermissions: InsidePermissions });
//     await Get_Damagedstock(userid)
//       .then((res) => {
//         let Data = res?.damageItems?.filter(
//           (ele) => ele?.warehouse?.typeStatus == "Wastage"
//         );
